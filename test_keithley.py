...
## Configuration
COM_PORT = 'COM5'   # Find the port in the list of device manager
GPIB_ADDR = 5       # From the menu->communication in the front panel of the instrument

keithley = Keithley2400.Device(COM_PORT, GPIB_ADDR) # Set the word keithley to call the functions from the instrument

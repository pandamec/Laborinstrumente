class System_service:
    ...
    def getDeviceName(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: actual device name
    ...
    def errorNumberToString(self, language, errNbr):
        ...
        Parameters:
            language: integer: Language code 0 for the error name, 1 for a more user friendly error messageerrNbr: interger: Error code to translate        

        Returns:
            value_errNo: errNo errorCodevalue_string: string: Error description
    ...
    def errorNumberToRecommendation(self, language, errNbr):
        ...
        Parameters:
            language: integer: Language codeerrNbr: interger: Error code to translate        

        Returns:
            value_errNo: errNo errorCodevalue_string: string: Error recommendation (currently returning an int = 0 until we have recommendations)
    ...
    def getFirmwareVersion(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: The firmware version
    ...
    def getHostname(self):
        ...
        Returns:
            value_errNo: errNo errorCodeavailable: available
    ...
    def getMacAddress(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: Mac address of the system
    ...
    def getSerialNumber(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: Serial number
    ...
    def getFluxCode(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: flux code
    ...
    def setTime(self, day, month, year, hour, minute, second):
        ...
        Parameters:
            day: integer: Day (1-31)month: integer: Day (1-12)year: integer: Day (eg. 2021)hour: integer: Day (0-23)minute: integer: Day (0-59)second: integer: Day (0-59)        
        """

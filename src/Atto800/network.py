class Network:
    def __init__(self, device):
        self.device = device
        self.interface_name = "com.attocube.cryostat.interface.network"
    ...
    def getRealIpAddress(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_IP: IP address as string
    ...
    def getSubnetMask(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_Subnet: Subnet mask as string
    ...
    def getDefaultGateway(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_Default: Default gateway
    ...
    def getDnsResolver(self, priority):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_IP: IP address of DNS resolver
    ...
    def setDnsResolver(self, priority, resolver):
        ...
        Parameters:
            priority: of DNS resolver (Usually: 0 = Default, 1 = Backup)resolver: The resolver's IP address as string        
        """
    ...
    def getProxyServer(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_Proxy: Proxy Server String, empty for no proxy
    ...
    def getEnableDhcpServer(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_boolean: boolean: true = DHCP server enable, false = DHCP server disable
    ...
    def getEnableDhcpClient(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_boolean: boolean: true = DHCP client enable, false = DHCP client disable
    ...
    def getWifiPresent(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_True: True, if interface is present
    ...
    def getWifiMode(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_mode: mode 0: Access point, 1: Wifi client
    ...
    def getWifiSSID(self):
        ...
        Returns:
            value_errNo: errNo errorCodeSSID: SSID
    ...
    def getWifiPassphrase(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_psk: psk Pre-shared key
    ...
    def configureWifi(self, mode, ssid, psk):
        ...
        Parameters:
            mode: 0: Access point, 1: Wifi clientssid: psk: Pre-shared key        
        """

class Update:
    def __init__(self, device):
        self.device = device
        self.interface_name = "com.attocube.cryostat.interface.update"
    ...
    def getSwUpdateProgress(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_int: int: progress in percent
    ...
    def uploadSoftwareImageBase64(self, offset, b64Data):
        ...
        Parameters:
            offset: int: offset of the datab64Data: string: base64 data        
        """

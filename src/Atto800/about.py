class About:
    ...
    def getInstalledPackages(self):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: Comma separated list of packages
    ...
    def getPackageLicense(self, pckg):
        ...
        Returns:
            value_errNo: errNo errorCodevalue_string: string: License for this package
